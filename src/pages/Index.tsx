      ...
      <section className="py-20">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto space-y-8 animate-fade-in">
            ...
            <div className="h-1 w-20 bg-lcm-blue mx-auto"></div>
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-10">
              <div className="p-6 bg-white rounded-lg shadow-sm border border-gray-100 animate-fade-up" style={{ animationDelay: '0.4s' }}>
                <div className="w-12 h-12 bg-lcm-blue/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-lcm-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
